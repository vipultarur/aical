...
final class PlannerRecipeRecommendation {
  ...
  @override
  String toString() {
    return 'PlannerRecipeRecommendation(name: $name, category: $category, calories: $calories)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is PlannerRecipeRecommendation &&
        other.name == name &&
  ...
  @override
  int get hashCode =>
      Object.hash(name, category, calories, protein, carbs, fat, slot, emoji);
}
